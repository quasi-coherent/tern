...
pub trait MigrationContext: Send + Sync {
    ...
    /// results in.
    fn history_table(&self) -> RelationId;
}
...
/// The identifier for a database relation.
///
/// A [`MigrationContext`] supplies the `RelationId` of the migration state
